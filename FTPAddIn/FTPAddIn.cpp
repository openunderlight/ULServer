// FTPAddIn.cpp : Defines the initialization routines for the DLL.
//
...
class CFTPAddInApp : public CWinApp
{
public:
	CFTPAddInApp();
...
// Overrides
	...
	//{{AFX_VIRTUAL(CFTPAddInApp)
	public:
	virtual BOOL InitInstance();
	virtual int ExitInstance();
	//}}AFX_VIRTUAL

	//{{AFX_MSG(CFTPAddInApp)
...
BEGIN_MESSAGE_MAP(CFTPAddInApp, CWinApp)
	//{{AFX_MSG_MAP(CFTPAddInApp)
...
/////////////////////////////////////////////////////////////////////////////
// The one and only CFTPAddInApp object

CFTPAddInApp theApp;

/////////////////////////////////////////////////////////////////////////////
// CFTPAddInApp construction

CFTPAddInApp::CFTPAddInApp()
{
...
/////////////////////////////////////////////////////////////////////////////
// CFTPAddInApp initialization

BOOL CFTPAddInApp::InitInstance()
{
	_Module.Init(ObjectMap, m_hInstance);
	return CWinApp::InitInstance();
}

int CFTPAddInApp::ExitInstance()
{
	_Module.Term();
...
STDAPI DllRegisterServer(void)
{
	...
	if (lRes == ERROR_SUCCESS)
	{
		...
		if (lRes == ERROR_SUCCESS)
		{
			...
			strDescription.LoadString(IDS_FTPADDIN_DESCRIPTION);
