...
* // MODIFIED BY LYRA, 10/00, FOR USE UNDER LINUX
*
...
#define _i64tot     i64tow
#define _ui64tot    ui64tow
...
#define _tcsicoll   wcsicoll
#define _tcsnccoll  wcsncoll
#define _tcsncoll   wcsncoll
#define _tcsncicoll wcsnicoll
#define _tcsnicoll  wcsnicoll
...
#define _texecv     wexecv
#define _texecve    wexecve
#define _texecvp    wexecvp
#define _texecvpe   wexecvpe

#define _tspawnl    wspawnl
#define _tspawnle   wspawnle
#define _tspawnlp   wspawnlp
#define _tspawnlpe  wspawnlpe
#define _tspawnv    wspawnv
#define _tspawnve   wspawnve
#define _tspawnvp   wspawnvp
#define _tspawnvp   wspawnvp
#define _tspawnvpe  wspawnvpe
...
#define _tfullpath  wfullpath
#define _tgetenv    wgetenv
#define _tmakepath  wmakepath
#define _tputenv    wputenv
#define _tsearchenv wsearchenv
#define _tsplitpath wsplitpath
...
#define _ttempnam   wtempnam
#define _ttmpnam    wtmpnam
...
#define _tfindfirsti64  wfindfirsti64
#define _tfindnext  wfindnext
#define _tfindnexti64   wfindnexti64
...
#define _tcsncset   wcsnset

#define _tcsdec     wcsdec
#define _tcsinc     wcsinc
#define _tcsnbcnt   wcsncnt
#define _tcsnccnt   wcsncnt
#define _tcsnextc   wcsnextc
...
#define _tcschr     mbschr
#define _tcscspn    mbscspn
#define _tcsncat    mbsnbcat
#define _tcsncpy    mbsnbcpy
#define _tcspbrk    mbspbrk
#define _tcsrchr    mbsrchr
#define _tcsspn     mbsspn
#define _tcsstr     mbsstr
#define _tcstok     mbstok

#define _tcsnset    mbsnbset
#define _tcsrev     mbsrev
#define _tcsset     mbsset

#define _tcscmp     mbscmp
#define _tcsicmp    mbsicmp
#define _tcsnccmp   mbsncmp
#define _tcsncmp    mbsnbcmp
#define _tcsncicmp  mbsnicmp
#define _tcsnicmp   mbsnbicmp

#define _tcscoll    mbscoll
#define _tcsicoll   mbsicoll
#define _tcsnccoll  mbsncoll
#define _tcsncoll   mbsnbcoll
#define _tcsncicoll mbsnicoll
#define _tcsnicoll  mbsnbicoll


/* "logical-character" mappings */

#define _tcsclen    mbslen
#define _tcsnccat   mbsncat
#define _tcsnccpy   mbsncpy
#define _tcsncset   mbsnset


/* MBCS-specific mappings */

#define _tcsdec     mbsdec
#define _tcsinc     mbsinc
#define _tcsnbcnt   mbsnbcnt
#define _tcsnccnt   mbsnccnt
#define _tcsnextc   mbsnextc
#define _tcsninc    mbsninc
#define _tcsspnp    mbsspnp

#define _tcslwr     mbslwr
#define _tcsupr     mbsupr

#define _tclen      mbclen
#define _tccpy      mbccpy
...
#define _istalnum   ismbcalnum
#define _istalpha   ismbcalpha
#define _istdigit   ismbcdigit
#define _istgraph   ismbcgraph
#define _istlegal   ismbclegal
#define _istlower   ismbclower
#define _istprint   ismbcprint
#define _istpunct   ismbcpunct
#define _istspace   ismbcspace
#define _istupper   ismbcupper

#define _totupper   _mbctoupper
#define _totlower   _mbctolower

#define _istlead    ismbblead
